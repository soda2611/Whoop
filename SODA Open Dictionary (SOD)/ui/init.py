...
def config():
    ...
    return boost_performance_require, bg, boxbg, menubg, btn, primarycolor, secondarycolor, colors, recent_search, fonts_name, noti_require, engine, word__, source, home__, queried, version, translator, data_

boost_performance_require, bg, boxbg, menubg, btn, primarycolor, secondarycolor, colors, recent_search, fonts_name, noti_require, engine, word__, source, home__, queried, version, translator, data_=config()
firstscreen=None
secondscreen=None
