...
class Setting(MDBoxLayout):
    def __init__(self, **kwargs):
        ...
        self.noti_box=MDBoxLayout(size_hint=(1, None), height=50*scale, pos_hint={'center_x': 0.5, 'center_y': 0.5}, spacing = 20)
        self.noti_box.switch_box=MDBoxLayout(size_hint=(0.25, None), height=50*scale, pos_hint={'center_x': 0.5, 'center_y': 0.5}, spacing = 20)
        self.noti_box.time_value_box=MDBoxLayout(size_hint=(0.75, None), height=50*scale, pos_hint={'left': 0.9, 'center_y': 0.8}, spacing = 20)
        self.noti_check_title=MDLabel(text="Gợi ý từ mới qua thông báo", font_style="H6", size_hint=(1, None), height=30*scale, pos_hint={'center_x': 0.5, 'center_y': 0.5}, theme_text_color="Custom", text_color=primarycolor)
        ...
        self.noti_time_title=MDLabel(text="Thời gian chờ thông báo", font_style="Body2", halign="right", size_hint=(0.5, None), pos_hint={"right": 0.7}, height=30*scale, theme_text_color="Custom", text_color=primarycolor)        
    ...
    def create_layout_preview(self, i):
        self.temp_box=MDCard(md_bg_color=(1,1,1,1), size_hint=(None, None), width=100*scale, height=100*scale, padding=[10, 10, 10, 10], spacing=20, ripple_behavior=True, on_press=lambda instance: self.change_homepage_layout(instance, "box"))
...
Nhật
        ...
        self.container=MDCard(orientation="vertical", spacing=20, size_hint=(1,None), height=200*scale, padding=[10,10,10,10])
