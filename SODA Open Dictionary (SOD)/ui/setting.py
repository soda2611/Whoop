...
class setting(MDBoxLayout):
    def __init__(self, **kwargs):
        ...
        self.noti_box.check=MDSwitch(icon_inactive="close", icon_active="check", icon_active_color=primarycolor, icon_inactive_color=secondarycolor, thumb_color_inactive=btn, thumb_color_active=boxbg, track_color_inactive=boxbg, track_color_active=btn)
