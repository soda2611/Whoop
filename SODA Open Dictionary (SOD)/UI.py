...
def config():
    ...
    global boost_performance_require, bg, boxbg, menubg, btn, primarycolor, secondarycolor, colors, recent_search, fonts_name, noti_require, engine, word__, source, home__, version, translator, data_
    ...
    def create_content_box(self, text, style=settings["homepage style"]):
        if style=="box":
            try:
                ...
                self.content_box.result_label=MDLabel(font_size=25, size_hint=(0.9,None), pos_hint={"left":1}, theme_text_color="Custom", text_color=primarycolor)
                ...
                self.content_box.morebutton=MDFillRoundFlatButton(text="Xem thêm", size_hint=(None, None), pos_hint={"center_y":0.5}, md_bg_color=btn, theme_text_color="Custom", text_color=secondarycolor)
            ...
            try:
                ...
                self.content_box.result_head_label.bind(texture_size=self.content_box.result_head_label.setter('text_size'))
                self.content_box.result_head_label.bind(texture_size=self.content_box.result_head_label.setter('size'))
                self.content_box.result_label=MDLabel(font_size=25, size_hint=(1,0.6), halign="center", valign="top", pos_hint={"center_x":0.5}, theme_text_color="Custom", text_color=primarycolor)
                ...
                self.content_box.result_label.bind(texture_size=self.content_box.result_label.setter('text_size'))
                self.content_box.result_label.bind(texture_size=self.content_box.result_label.setter('size'))
                self.content_box.morebutton=MDFillRoundFlatButton(text="Xem thêm", size_hint=(None, None), pos_hint={"center_x":0.5}, md_bg_color=btn, theme_text_color="Custom", text_color=secondarycolor)
                self.content_box.tilte_and_description_box.add_widget(self.content_box.result_head_label)
                if text["level"]!="none":
        ...
        if len(result)<=1:
            if result_!="Không tìm thấy từ":
                ...
                if result_["translation"]!="none":
                    self.translation.text=f'Dịch: {result_["translation"]}'
                    try:
                ...
                if result_["word"] not in recent_search:
                    ...
                    recent_search=[result_["word"]]+recent_search
                ...
                for i in range(len(synonyms)):
                    if count<=5:
                        ...
                        break
                if (synonyms!=[]) and (count!=0) and (synonyms!='none'):
