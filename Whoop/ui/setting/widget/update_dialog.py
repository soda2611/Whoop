...
class update_dialog(MDBottomSheet):
    def __init__(self, **kwargs):
        ...
        self.official.add_widget(MDLabel(text=f"[b]Dữ liệu chính thức[/b]", pos_hint={"center_x": 0.5}, halign="center", valign="top", size_hint=(1, 1), markup=True))
        ...
        self.early_access.add_widget(MDLabel(text=f"[b]Truy cập sớm[/b]", pos_hint={"center_x": 0.5}, halign="center", valign="top", size_hint=(1, 1), markup=True))
        self.early_access.add_widget(MDLabel(text=f"[size={int(dp(12))}]Truy cập sớm vào phiên bản dữ liệu mới nhất, tuy nhiên tốc độ cập nhật chậm hơn[/size]", pos_hint={"center_x": 0.5}, halign="center", valign="top", size_hint=(1, 1), markup=True))
