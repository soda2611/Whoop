...
class home(MDBoxLayout, TouchBehavior):
    def __init__(self, **kwargs):
        ...
        self.back_button=MDIconButton(icon="arrow-left", theme_icon_color="Custom", pos_hint={"center_y": 0.5}, icon_color=primarycolor, md_bg_color=(1,1,1,0), disabled=True, md_bg_color_disabled=boxbg, on_press=self.back)
