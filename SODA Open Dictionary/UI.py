...
sod=SODA_Open_Dictionary()
SOD=sod.SOD
grammar_structure_detector=sod.grammar_structure_detector
SOD_word_list=sod.SOD_word_list
word_detector=sod.word_detector
...
class SettingLayout(MDBoxLayout):
    def __init__(self, **kwargs):
        ...
        self.layout_list=MDBoxLayout(size_hint=(None, 1), pos_hint={"center_x": 0.5}, spacing=10, padding=[10,10,10,10])
